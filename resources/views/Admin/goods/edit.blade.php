...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" method="post" action="/admin/admingoods/{{$d->goods_id}}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$d->goods_name}}" placeholder="" id="" name="goods_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$d->goods_price}}" placeholder="" id="" name="goods_price">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$d->goods_num}}" placeholder="" id="" name="goods_num">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="type_id" class="select">
						...
						@foreach($data as $k=>$v)
							<option value="{{$v->id}}"  {{$v->id==$d->type_id?'selected':''}}>{{$v->name}}</option>
						@endforeach
				</select>
				</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="goods_describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{$d->goods_describe}}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="goods_status" class="select">
					<option value="0" {{$d->goods_status==0?'selected':''}}>上架</option>
					<option value="1" {{$d->goods_status==1?'selected':''}}>下架</option>
				</select>
				</span>
			</div>
		</div>
		<input type="hidden" name="goods_addtime" value="{{time()}}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图片：</label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/{{$d->goods_pic}}" width="100px" alt="">
		</div>
    <div class="row cl">
