...
<div class="page-container">
 ...
 <!--  @if(count($errors) > 0)
    ...
    @foreach ($errors->all() as $k=>$error)
      <li>
        <label style="color:red;"  class=" radius size-S">{{ $error }}</label>
      </li>
    @endforeach
    </div>
    </ul>
  ...
  @endif -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('goods_price')}}" placeholder="" id="" name="goods_price">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('goods_num')}}" placeholder="" id="" name="goods_num">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="goods_describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{old('goods_describe')}}</textarea>
