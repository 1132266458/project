...
<div class="page-container">
	<div class="text-c">
		<form action="/admin/admincates" method="get">
			<input type="text" name="keywords" id="" placeholder="栏目名称、id" style="width:250px" class="input-text" value="{{$request['keywords'] or ''}}">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" onclick="system_category_add('添加资讯','/admin/admincates/create',700,500)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
		</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			@foreach($data as $v)
				<tr class="text-c">
					...
					<td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('栏目编辑','/admin/admincates/{{$v->id}}/edit','1','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
