...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/admingoods" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>
					<li><a data-href="/admin/admincates" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
			</ul>
		</dd>
	</dl>
		...
		<dt><i class="Hui-iconfont">&#xe62d;</i> 管理员管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					...
					<li><a data-href="/admin/adminnode" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<img src="/shops/timg.jpg" width="1150px" alt="">
	</div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/shops/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
