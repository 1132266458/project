...
<article class="page-container">
	...
	<div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/shops/images/user.png" width="100px"></div>
	
	<dl  class="right_xxln">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名：</label>
		<div class="formControls col-xs-8 col-sm-9 c" >
			{{$info->admininfo_name}}
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal c">
			@if($info->admininfo_sex==0)
			女
			@elseif($info->admininfo_sex==1)
			男
			@else
			保密
			@endif
