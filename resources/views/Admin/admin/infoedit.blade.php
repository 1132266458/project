...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" method="post" action="/admin/admininfo_update/{{$data->admininfo_id}}" >
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员姓名：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="adminName" name="admininfo_name" value="{{$data->admininfo_name}}">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="admininfo_sex" size="1">
				<option value="0" {{$data->admininfo_sex==0?'selected':''}}>女</option>
				<option value="1" {{$data->admininfo_sex==1?'selected':''}}>男</option>
				<option value="2" {{$data->admininfo_sex==2?'selected':''}}>保密</option>
			</select>
			</span> </div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="adminName" name="admininfo_qq" value="{{$data->admininfo_qq}}">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="adminName" name="admininfo_email" value="{{$data->admininfo_email}}">
		</div>
	</div>
	{{csrf_field()}}
	<div class="row cl">
