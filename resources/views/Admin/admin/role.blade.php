	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		@foreach($data as $v)
			<tr class="text-c">
				...
				<td>{{$v->level_name}}</td>
				<td class="f-14">
				<a title="权限设置" href="javascript:;" onclick="admin_role_edit('权限编辑','/admin/adminauth/{{$v->admin_level}}','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe61f;</i></a> 
				<a title="删除" href="javascript:;" onclick="admin_role_del(this,{{$v->admin_level}})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
		@endforeach
		</tbody>
	</table>
