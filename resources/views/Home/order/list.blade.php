        ...
        <div class="member-right fr">
            ...
            <div class="member-whole clearfix">
                <ul id="H-table" class="H-table">
                    <li class="cur"><a href="javascript:;">我的订单({{$d}})</a></li>
                    <li><a href="javascript:;">待付款<em>({{$wei}})</em></a></li>
                    <li><a href="javascript:;">待发货<em>({{$dd}})</em></a></li>
                    <li><a href="javascript:;">待收货<em>({{$ddd}})</em></a></li>
                    <li><a href="javascript:;">交易完成<em>({{$dddd}})</em></a></li>
                        ...
                        <!-- {{var_dump($v)}} -->
                           <li class="dd{{$v->order_id}}">
                               ...
                               <div class="member-circle clearfix">
                                  ...
                                  @elseif($v->order_state==3)
                                  <p>剩余6天23小时</p> <p><a href="javascript:;" onclick="getu({{$v->order_id}})" class="member-touch">确认收货</a> </p>
                                  <p><a href="javascript:;" onclick="cancel(this,{{$v->order_id}})">取消订单</a> </p>
