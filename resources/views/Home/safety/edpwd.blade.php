        ...
        <div class="login-box" style="visibility: visible; display:block">
          ...
          <div class="mc">
            <div class="form">
              ...
              {{session('error')}}
              @endif
              <form action="/doedpwd" id="formlogin" method="post" >
                {{csrf_field()}}
                <div id="entry" class="item item-fore2" style="visibility: visible">
                  <label class="login-label pwd-label" for="nloginpwd"></label>
                  <input type="password" name="user_pwd" id="nloginpwd" name="nloginpwd" class="itxt itxt-error" tabindex="2" autocomplete="off" placeholder="原密码">
                ...
                <div id="entry" class="item item-fore2" style="visibility: visible">
                  <label class="login-label pwd-label" for="nloginpwd"></label>
                  <input type="password" name="user_repwd" id="nloginpwd" name="nloginpwd" class="itxt itxt-error" tabindex="2" autocomplete="off" placeholder="新密码">
                  <span class="clear-btn" style="display: inline;"></span>
                  <span class="capslock" style="display: none;">
                    <b></b>
                    大小写锁定已打开
                ...
                <div id="entry" class="item item-fore2" style="visibility: visible">
                  <label class="login-label pwd-label" for="nloginpwd"></label>
                  <input type="password" name="user_repwd2" id="nloginpwd" name="nloginpwd" class="itxt itxt-error" tabindex="2" autocomplete="off" placeholder="确认密码">
                  <span class="clear-btn" style="display: inline;"></span>
                  <span class="capslock" style="display: none;">
                    <b></b>
                    大小写锁定已打开
                ...
                <!-- 图片验证码开始 fore3-->
                        ...
                        <div class="item item-fore5">
                          <div class="login-btn">
                            <input type="submit" class="btn-img btn-entry" value="确认修改">
                          </div>
                        </div>
              </form>
            </div>
