    ...
    <div class="member-center clearfix">
        <div class="member-left fl">
            <div class="member-apart clearfix">
                ...
                <div class="fl">
                    <p>用户名：</p>
                    <p><a href="#">{{session('user_name')}}</a></p>
                    <p>搜悦号：</p>
                    <p>389323080</p>
                </div>
            </div>
               ...
               <div class="member-caution clearfix">
                   <ul>
                       ...
                       <li class="clearfix">
                           ...
                           <div class="warn3">您验证的邮箱 <i class="reds">{{$info->user_email}}</i> </div>
                           <div class="warn4"><a href="/useredemail">更换邮箱</a> </div>
                       </li>
                       <li class="clearfix">
                           <div class="warn1"></div>
                           <div class="warn2">手机验证</div>
                           <div class="warn3">您验证的手机： <i class="reds">{{$info->user_phone}}</i>   若已丢失或停用，请立即更换，<i class="reds">避免账户被盗</i></div>
