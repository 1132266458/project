...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="/dotui">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>退货理由：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                <select name="reason_level" class="select">
                        <option value="">--请选择--</option>
                        <option value="1">货不对板</option>
                        <option value="2">货物质量有问题</option>
                        <option value="3">发错货了</option>
                </select>
                </span>
            </div>
        </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="reason" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">{{old('reason')}}</textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		
        <input type="hidden" name="return_addtime" value="{{time()}}">
