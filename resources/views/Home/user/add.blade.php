            ...
            <div class="member-border">
              <div class="member-sites">
                    <ul>
                        ...
                        <li class="clearfix">
                        <form action="/homeuser" method="post" enctype="multipart/form-data">
                        
                            <div class="default fl"></div>
                            <div class="user-info1 fl clearfix">
                                <div class="user-info">
                                    <span class="info1">当前头像：</span>
                                    <span class="info2"><img src="/theme/img/bg/mem.png" alt=""></span>
                                </div>
                                <div class="user-info">
                                ...
                                <div class="user-info">
                                    ...
                                    <input class="info2" type="text" name="userinfo_pname">
                                </div>
                                <div class="user-info">
                                    <span class="info1">真实姓名：</span>
                                    <input class="info2" type="text" name="userinfo_name" value="">
                                </div>
                                <div class="user-info">
                                    <span class="info1">性别：</span>
                                    <input  type="radio" name="userinfo_sex" value="1" checked>男&nbsp;&nbsp;&nbsp;&nbsp; <input  type="radio" name="userinfo_sex" value="0">女&nbsp;&nbsp;&nbsp;&nbsp; <input  type="radio" name="userinfo_sex" value="2">保密
                                </div>
                                <div class="user-info">
                                    <span class="info1">生日：</span>
                                    <input class="info2" type="text" name="userinfo_birthday">
                                </div>
                                <div class="user-info">
                                    <span class="info1">爱好：</span>
                                    <input class="info2" type="text" name="userinfo_hobby">
                                </div>
                                <div class="user-info">
                                    <span class="info1">居住地：</span>
                                    <input class="info2" type="text" name="userinfo_address">
                                </div>
                                <div class="user-info">
                                   {{csrf_field()}}
