...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" method="post" action="/admin/admingoods/<?php echo e($d->goods_id); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e($d->goods_name); ?>" placeholder="" id="" name="goods_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e($d->goods_price); ?>" placeholder="" id="" name="goods_price">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e($d->goods_num); ?>" placeholder="" id="" name="goods_num">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="type_id" class="select">
						...
						<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($v->id); ?>"  <?php echo e($v->id==$d->type_id?'selected':''); ?>><?php echo e($v->name); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="goods_describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo e($d->goods_describe); ?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="goods_status" class="select">
					<option value="0" <?php echo e($d->goods_status==0?'selected':''); ?>>上架</option>
					<option value="1" <?php echo e($d->goods_status==1?'selected':''); ?>>下架</option>
				</select>
				</span>
			</div>
		</div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/<?php echo e($d->goods_pic); ?>" width="100px" alt="">
		</div>
    <div class="row cl">
