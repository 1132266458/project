...
<div class="Interface_spacing clearfix">
  <div class="order_detailed">
    ...
    订单编号：<b><?php echo e($order->order_sn); ?></b>
    <span class="r_f">下单时间：<?php echo e(date('Y-m-d h:m:s',$order->order_addtime)); ?></span>
    </div>
    <div class="order_content clearfix">
     <div class="Buyers_info margin-bottom clearfix">
       <ul>
       <li><label class="title_name">收货人姓名：</label><span><?php echo e($address->name); ?></span></li>
       <li><label class="title_name">收人人电话：</label><span><?php echo e($address->address_phone); ?></span></li>
       <li><label class="title_name">地址邮编：</label><span><?php echo e($address->address_code==0?'未知':$address->address_code); ?></span></li>
       <li><label class="title_name">备&nbsp;&nbsp;&nbsp;&nbsp;注：</label><span><?php echo e($order->order_messeges==null?'无备注':$order->order_messeges); ?></span></li>
       <li class="address"><label class="title_name">收货地区：</label><span><?php echo e($address->address_location); ?></span></li>     
       <li class="address"><label class="title_name">详细地址：</label><span><?php echo e($address->address); ?></span></li>     
       </ul>
     </div>
     <table  class="table table_list table_striped  table-bordered">
      ...
      <tbody>
      <?php $__currentLoopData = $go; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <!-- <?php echo e(var_dump($v)); ?> -->
       <tr>
        <td class="product_name text-align">
        <a href="#" class="link_name">
        <div class="l_f img"><img src="/<?php echo e($v->goods_pic); ?>"  width="80px" height="80px"/></div>
     ...
     <div class="order_info Buyers_info margin-sx clearfix">
      <ul>
       ...
       <li><label class="title_name">支付状态：</label><span><?php if($order->order_state==1): ?> 待付款 <?php else: ?> 已付款 <?php endif; ?></span></li>
     ...
     <div class="right_Price">
      <p><span class="Price_name">总价：</span><b class="font_size_das color_mu">￥<?php echo e($order->order_amount); ?></b></p>
      </div>
     </div>
    </div>
  </div>
