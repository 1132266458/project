...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" onclick="picture_add('添加商品','/admin/admingoods/create')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a></span> <span class="r">共有数据：<strong id="tot"><?php echo e($tot); ?></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="text-l"><?php echo e($v->goods_name); ?></td>
					<td><?php echo e($type[$k]); ?></td>
					<td><a href="javascript:;" onClick="picture_list('图库查看','/admin/piclist/<?php echo e($v->goods_id); ?>')"><img height="100" class="picture-thumb" src="/<?php echo e($v->goods_pic); ?>"></a></td>
					
					<td class="text-c"><?php echo e($v->goods_num); ?></td>
					<td class="text-c"><?php echo e($v->goods_price); ?>￥</td>
					<td class="text-c"><?php echo e($v->goods_describe); ?></td>
					<td><?php echo e(date('Y-m-d h:m:s',$v->goods_addtime)); ?></td>
				...
				<?php endif; ?>
					<td class="td-manage">
					<?php if($v->goods_status==0): ?>
					<a style="text-decoration:none" onClick="picture_stop(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="下架" id="status"><i class="Hui-iconfont">&#xe6de;</i></a> 
					<?php else: ?>
					<a style="text-decoration:none" onClick="picture_start(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="发布" id="status"><i class="Hui-iconfont">&#xe6dc;</i></a>
					<?php endif; ?>
					<?php if($v->goods_ads==0): ?>
					<a style="text-decoration:none" onClick="ads_stop(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="取消推荐"><i class="Hui-iconfont">&#xe706;</i></a>
					<?php else: ?>
					<a style="text-decoration:none" onClick="ads_start(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="推荐"><i class="Hui-iconfont">&#xe6c1;</i></a>
					<?php endif; ?>
					<a style="text-decoration:none" class="ml-5" onClick="picture_edit('图库编辑','/admin/admingoods/<?php echo e($v->goods_id); ?>/edit')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
					<a style="text-decoration:none" class="ml-5" onClick="pic_add('添加图库','/admin/picadd/<?php echo e($v->goods_id); ?>')" href="javascript:;" title="添加图库"><i class="Hui-iconfont">&#xe61f;</i></a>
					
					<a style="text-decoration:none" class="ml-5" onClick="pic_add('添加商品详情','/admin/details/<?php echo e($v->goods_id); ?>')" href="javascript:;" title="添加商品详情"><i class="Hui-iconfont">&#xe64f;</i></a>

					<a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'<?php echo e($v->goods_id); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
