 ...
 <body> 
  ...
  <header id="pc-header"> 
   ...
   <div class="container clearfix"> 
    ...
    <div class="header-cart fr">
     ...
     <i class="head-amount"><?php echo e(session()->has('shop')?count(session('shop')):'0'); ?></i>
    </div> 
  ...
  <div class="containers">
   <div class="pc-nav-item">
    ...
    <a href="#" style="color:black;"><?php echo e($name); ?></a>
   </div>
  </div> 
  ...
  .list ul li ul li ul li a{ color:#316a91; padding-left:30px;}
   ...
   <div class="pc-info fr"> 
    ...
    <div class="time-border-list pc-search-list clearfix"> 
      ...
      <li> <a href="/homepage/<?php echo e($good->goods_id); ?>"> <img src="/<?php echo e($good->goods_pic); ?>" width="240px" height="280px" /></a> <p class="head-name"><a href="/homepage/<?php echo e($good->goods_id); ?>" style="font-size:12px;color:black;"><?php echo e($good->goods_describe); ?></a> </p> <p><span class="price">￥<?php echo e($good->goods_price); ?></span></p> <p class="head-futi clearfix"><span class="fl">好评度：90% </span> <span class="fr">100人购买</span></p> <p class="clearfix"><span class="label-default fl">抢购</span> <a href="javascript:;" class="fr pc-search-c" onclick="foverite(<?php echo e($good->goods_id); ?>)" style="color:black;">收藏</a> </p> </li> 
      <?php endif; ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     </ul> 
     <div class="clearfix"> 
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
  ...
  function page(page){
  $("#pagesx").val(page);
  $.get("/types/<?php echo e($cate_id); ?>",{page:page},function(data){
  //alert(data);
  //赋值给id值为 uid的div
  $("#uid").html(data);
  });
