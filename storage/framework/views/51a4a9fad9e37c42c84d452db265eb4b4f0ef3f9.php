    ...
    <div class="containers">
        ...
        <div class="pc-border">
            <div class="pc-order-text">
                <p>订单提交成功，请您尽快付款！   订单号 ：<em><?php echo e($info['order_sn']); ?></em></p>
                <p class="reds">请您在提交订单后24小时内完成付款，否则订单自动取消。</em></p>
            </div>
            <div class="pc-line"></div>
            <div class="pc-order-text">
                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span><p>商品名称: <?php echo e($v['goodsinfo']->goods_name); ?></p><p>商品详情: <?php echo e($v['goodsinfo']->goods_describe); ?></p><span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <p>收货地址：<?php echo e($address->address_location); ?> <?php echo e($address->address); ?> 
                </p><p>收货人：<?php echo e($address->name); ?> <?php echo e($address->address_phone); ?></p>
            </div>
        </div>
    </div>
</section>
...
<div class="pc-buying clearfix" style="margin-top:30px">
    <div class="time-list time-list-w fl">
        <div class="time-title">
            ...
            <span class="pc-order-price">总价：<?php echo e(session('sum')); ?></span>
        </div>
        <div class="time-border time-border-h clearfix">
            ...
            <div class="pc-order-go"><a href="/pays/<?php echo e($info['order_sn']); ?>">去支付</a></div>
        </div>
    </div>
</div>
