...
<![endif]-->
<title>新增图片</title>
<link href="/shops/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" method="post" action="/admin/admingoods">
 <!--  <?php if(count($errors) > 0): ?>

    <ul style="position:absolute;right:0px;z-index:999;background-color:white">错误信息:
    <div style="border:1px solid black">
    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li>
        <label style="color:red;"  class=" radius size-S"><?php echo e($error); ?></label>
      </li>
  ...
  <?php endif; ?> -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(old('goods_name')); ?>" placeholder="" id="" name="goods_name">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(old('goods_price')); ?>" placeholder="" id="" name="goods_price">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(old('goods_num')); ?>" placeholder="" id="" name="goods_num">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="goods_describe" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo e(old('goods_describe')); ?></textarea>
		...
		<input type="hidden" name="goods_addtime" value="<?php echo e(time()); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图片上传：</label>
				<input type="file" name="goods_pic" class="btn btn-default btn-uploadstar radius ml-10">
		</div>
...
<script type="text/javascript" src="/shops/lib/webuploader/0.1.5/webuploader.min.js"></script> 
...
<?php if(count($errors) > 0): ?>
    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        layer.msg('<?php echo e($error); ?>',{icon:5,time:1000});
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    // alert($errors);
<?php endif; ?>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '/shops/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '/shops/lib/webuploader/0.1.5/server/fileupload.php',
