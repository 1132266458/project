...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><?php echo e($v->appraise_id); ?></td>
				<td><?php echo e($v->user_name); ?></td>
				<td><?php echo e($v->goods_name); ?></td>
				<td><?php echo e($v->appraise_coment); ?></td>
				<td><?php echo e(date('Y-m-d h:m:s',$v->appraise_time)); ?></td>
				<td class="td-status">
				<?php if($v->appraise_leval==0): ?>
				<span class="label label-success radius">好评</span>
				<?php elseif($v->appraise_leval==1): ?>
				<span class="label label-warning radius">中评</span>
				<?php elseif($v->appraise_leval==2): ?>
				<span class="label label-danger radius">差评</span>
				<?php endif; ?>
				</td>
				<td><a title="回复评论" href="javascript:;" onclick="admin_address('回复评论','/admin/adminappraise/<?php echo e($v->appraise_id); ?>','700','400')" class="btn btn-primary radius size-S" style="text-decoration:none">回复评论</a><a title="回复评论" href="javascript:;" onclick="admin_show('查看回复','/admin/replyshow/<?php echo e($v->appraise_id); ?>','650','350')" class="btn btn-success radius size-S" style="text-decoration:none">查看回复</a></td>
			</tr>
