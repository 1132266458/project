    ...
    <div class="containers">
                   ...
                   <div class="pc-order-text clearfix">
                       ...
                       <div class="clearfix pc-wares-p">
                           ...
                           <div class="fl pc-wares">
                            <a href="#"><img style ="width:82px;height:82px;"src="<?php echo e($val['goodsinfo']->goods_pic); ?>"></a>
                          </div>
                           <div class="fl pc-wares-w">
                            <a href="#"><?php echo e($val['goodsinfo']->goods_name); ?></a> 
                            <p class="clearfix">
                              <span class="fl">描述：<?php echo e($val['goodsinfo']->goods_describe); ?></span>
                            </p>
                          </div>
                          <?php  $money=$val['goodsinfo']->goods_price*$val['num'];?>
                           <div class="fl pc-wares-s"><span class="reds">价格:<?php echo e($money); ?><b></b></span>
                         
                          <span>数量:<b><?php echo e($val['num']); ?></b></span></div>
       ...
       <div class="clearfix">
           <div class="fr pc-space-j">
               <spna>应付总额：<strong>￥<?php echo e(session('sum')); ?></strong></spna>
