...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="/adminarticles" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<center>
		<script id="editor" type="text/plain"  name="descr" style="width:100%;height:500px;">
		</script>
		</center>
			</div>
		</div>
