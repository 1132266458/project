		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			    ...
			    <?php endif; ?>
					...
					<td class="td-manage">
					<?php if($v->goods_status==0): ?>
					<a style="text-decoration:none" onClick="picture_stop(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> 
					<?php else: ?>
					<a style="text-decoration:none" onClick="picture_start(this,<?php echo e($v->goods_id); ?>)" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe6dc;</i></a>
					<?php endif; ?>
