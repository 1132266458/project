...
<article class="page-container">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>回复时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<?php echo e(date('Y-m-d h:m:s',$data->appraise_replytime)); ?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php echo e($data->appraise_reply); ?>
