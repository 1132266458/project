	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr class="text-c">
				...
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo e($v->user_name); ?>','/admin/adminusers/<?php echo e($v->user_id); ?>','360','400')"><?php echo e($v->user_name); ?></u></td>
				<td><?php echo e($v->user_pwd); ?></td>
				<td><?php echo e($v->user_phone); ?></td>
				
				<td><?php echo e($v->user_addtime); ?></td>
				<td class="td-status">
				<?php if($v->user_state==0): ?>
				...
				<td class="td-manage">
				<?php if($v->user_state==0): ?>
				<a style="text-decoration:none" onClick="member_stop(this,'<?php echo e($v->user_id); ?>')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631; </i></a> 
				<?php else: ?>
				<a style="text-decoration:none" onClick="member_start(this,'<?php echo e($v->user_id); ?>')" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1; </i></a>
				<?php endif; ?>

				 <a title="编辑" href="javascript:;" onclick="admin_address('收货地址','/admin/address/<?php echo e($v->user_id); ?>','850','550')" class="btn btn-primary radius size-S" style="text-decoration:none">收货地址</a>
				</td>
			</tr>
