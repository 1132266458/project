  ...
  <div class="containers"> 
   <div class="time-border-list pc-search-list clearfix"> 
    <ul class="clearfix">
     ...
     <li> <a href="/homepage/<?php echo e($row->goods_id); ?>"> <img src="/<?php echo e($row->goods_pic); ?>" width="240px" height="280px"/></a> <p class="head-name"><a href="/homepage/<?php echo e($row->goods_id); ?>"><?php echo e($row->goods_describe); ?></a> </p> <br><p><span class="price"><?php echo e($row->goods_price); ?></span></p> <p class="head-futi clearfix"><span class="fl">好评度：90% </span> <span class="fr">100人购买</span></p> <p class="clearfix"><span class="label-default fl">抢购</span> <a href="javascript:;" onclick="foverite(<?php echo e($row->goods_id); ?>)" class="fr pc-search-c">收藏</a> </p> </li> 
     <?php endif; ?>
