	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo e($row->slider_id); ?></td>
				<td><img src="/uploads/slider/<?php echo e($row->slider_img); ?>" width="200px"></td>
				<td><?php echo e($row->slider_title); ?></td>
				<td><?php echo e($row->slider_href); ?></td>								
...
function status(obj,id,statue){
	...
	if(statue==1){
		//发送ajax请求
		$.post("/admin/ajaxstatu",{admin_id:id,"_token":"<?php echo e(csrf_token()); ?>",admin_statue:0},function(data){
				if(data==1){
		...
		//发送ajax请求
		$.post("/admin/ajaxstatu",{admin_id:id,"_token":"<?php echo e(csrf_token()); ?>",admin_statue:1},function(data){
				if(data==1){
