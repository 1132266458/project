    ...
    <div class="containers">
                   ...
                   <ul class=" clearfix">
                       <li class="clearfix fl">
                          <div class="fl pc-address">
                            <?php if($v->address_statue == 1): ?>
                            <input type="radio"value="<?php echo e($v->address_id); ?> "name="address_id" checked>
                            <?php else: ?>
                            <input type="radio"value="<?php echo e($v->address_id); ?> "name="address_id">
                            <?php endif; ?>
                            <span><?php echo e($v->name); ?></span> 
                            <span><?php echo e($v->address_location); ?></span>
                            <span><?php echo e($v->address); ?></span>
                            <span><?php echo e($v->address_phone); ?></span>
                          </div>
                       </li>
                       <li class="fr">
                           <div class="pc-click">
                   ...
                   <div class="pc-order-text clearfix">
                       ...
                       <div class="clearfix pc-wares-p">
                           <div class="fl pc-wares">
                            <a href="#"><img style ="width:82px;height:82px;"src="<?php echo e($data->goods_pic); ?>"></a>
                          </div>
                           <div class="fl pc-wares-w">
                            <a href="#"><?php echo e($data->goods_name); ?></a> 
                            <p class="clearfix">
                              <span class="fl">描述：<?php echo e($data->goods_describe); ?></span>
                            </p>
                          </div>
                          <?php  $money=$data->goods_price*$data->num;?>
                           <div class="fl pc-wares-s"><span class="reds">价格:￥<?php echo e($data->goods_price); ?><b></b></span>
                         
                          <span>数量:<b><?php echo e($data->num); ?></b></span></div>
       ...
       <div class="clearfix">
           <div class="fr pc-space-j">
               <spna>应付总额：<strong>￥<?php echo e($money); ?></strong></spna>
               <input type="hidden" name="sum" value="<?php echo e($money); ?>">
               <input type="hidden" name="goods_id" value="<?php echo e($data->goods_id); ?>">
               <input type="hidden" name="num" value="<?php echo e($data->num); ?>">
