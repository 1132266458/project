...
<article class="page-container">
	<form action="/admin/adminreply" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>会员评论：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<?php echo e($data->appraise_coment); ?>

			</div>
		</div>
		<input type="hidden" name="appraise_replytime" value="<?php echo e(time()); ?>">
		<input type="hidden" name="appraise_id" value="<?php echo e($data->appraise_id); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评论回复：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="appraise_reply" maxlength="200" style="padding:10px;width: 415px;height: 152px;resize:none"></textarea>
			</div>
		</div>
